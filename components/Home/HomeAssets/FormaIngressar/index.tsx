        ...
        <div className={styles.formasDeIngressoContainer}>
            ...
            <div className={styles.formasDeIngressoContent}>
               ...
               <h4>VESTIBULAR ONLINE</h4>
                ...
                <p>O vestibular tradicional é aquele em que são divulgadas as datas relacionadas com o período de inscrição, datas das provas, matrículas, etc. Geralmente a FAZAG divulga um edital e/ou manual do candidato onde podem ser encontradas todas as informações referentes ao exame. Esse vestibular pode acontecer em uma ou mais fases, dependendo apenas do padrão implementado pela faculdade. As provas também não seguem um único padrão, ou seja, podem ser objetivas ou dissertativas, mas normalmente possuem uma redação.</p>
                </div>
                ...
                <Image src={enem} alt="" />
                <h4>NOTA DO ENEM</h4>
                <p>Junte os documentos necessários para ingressar com sua nota do ENEM. Veja a lista dos documentos necessários.</p>
                </div>
            </div>
        </div>
        </section>
