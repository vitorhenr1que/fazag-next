...
if(req.method === 'POST'){
    ...
    try {
        await transporter.sendMail({
           ...mailOptions,
           subject: '🗣️ Novo Agendamento | NUSP 🗣️',
           cc: 'vitor@fazag.edu.br',
       ...
       margin-bottom: 1rem;">
               ...
               <br/>${data.dataAgendada}</p><hr />

               <p><strong>Horário: </strong>
               <br/>${data.horario}:00</p><hr />
   
               <p><strong>Breve relato da demanda: </strong>
               <br/>${data.text}</p>
               </div>
